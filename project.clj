(defproject clojurescript-talk "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "clojurescript-talk.core/on-figwheel-reload"}

                :compiler {:main clojurescript-talk.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/clojurescript_talk.js"
               ...
               {:id "test"
                ...
                :compiler {:output-to "resources/public/js/compiled/testable.js"
                           :main clojurescript-talk.test-runner
                           :optimizations :none}}
